...
Namespace Commands
    Public Class DefaultCommand
        ...
        Private ReadOnly _parameter As String

        Public Sub New(ByVal optionObject2015 As OptionObject2015, ByVal parameter As String)
        ...
        Function Execute() As OptionObject2015 Implements IRunScriptCommand.Execute
            Return New OptionObject2015 With {
                ...
                .ErrorCode = 3,
                .ErrorMesg = "Error: There is no command matching the parameter '" + _parameter + "'. Please verify your settings.",
